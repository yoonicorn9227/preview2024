...
public class MServiceImpl implements MService {
	...
	public Map<String, Object> mSelectAll(int page, String gender, int viewColumnsCount, String SearchCategory,
			String SearchWord) {
		...
		System.out.println("MServiceImpl 성별 : " + gender);
		...
		int countAll = memberMapper.mSelectCountAll(gender,SearchCategory, SearchWord); // 2-a. 회원정보 리스트 총갯수
		...
		// 2. 회원 정보 리스트 가져오기 - ①번째
		ArrayList<MemberDto> list = memberMapper.mSelectAll(startContRowNum, endContRowNum, gender, SearchCategory,
				SearchWord);
